var showreel = function() {
	...
	d3.csv("files/abt/showreel/showreel.csv", function(data) {
	...
	function horizons() {
	  ...
	  g.each(function(d) {
		...
		d3.select(this).selectAll(".area")
			.data(d3.range(3))
		  .enter().insert("path", ".showreel-line")
			.attr("class", "area")
		...
		d3.select(this).selectAll(".showreel-line").transition()
			.duration(duration)
	...
	function areas() {
	  ...
	  g.select(".showreel-line")
		  .attr("d", function(d) { return axis(d.values); });

	  g.each(function(d) {
		y.domain([0, d.maxPrice]);

		d3.select(this).select(".showreel-line").transition()
			.duration(duration)
